    ...
    return $table
        ->columns([
            ...
            Tables\Columns\TextColumn::make('category')
                ...
                ->searchable()
                ->sortable(),
            Tables\Columns\TextColumn::make('division.name') // Tampilan divisi
                ->label('Divisi')
                ->searchable()
                ->sortable()
                ->formatStateUsing(fn (?string $state, Document $record): string =>
                    $record->division_id === null ? 'Semua Divisi (Global)' : $state // Tampilan global
                ),
        ...
        ->filters([
            ...
            Tables\Filters\SelectFilter::make('category')
                ->options([
                    'Forms & Templates' => 'Forms & Templates', 'Company Policies' => 'Company Policies',
                    'Training Materials' => 'Training Materials', 'Reports' => 'Reports', 'Other' => 'Other',
                ])
